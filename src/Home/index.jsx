...
export default class Path extends Component {
  ...
  visualize(algo) {
    if (!this.state.isRunning) {
      ...
      this.execute(visitedNodesInOrder, nodesInShortestPathOrder);
    }
  }

  execute(visitedNodesInOrder, nodesInShortestPathOrder) {
  ...
  render() {
    const { grid, mouseIsPressed, grapDrawer, divideConquerDrawer } = this.state;
    return (
      <div className='container'>
        ...
        {
          divideConquerDrawer && <Towers discsNumber={7} />
        }
      </div>
    );
  }
